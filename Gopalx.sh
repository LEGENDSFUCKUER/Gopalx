...
banner() {
	cat <<- EOF
                ...
                ${BLUE}  ╚██████╔╝╚█████╔╝██║░░██║██║░░░░░███████╗
                ${BLUE}  ░╚═════╝░░╚════╝░╚═╝░░╚═╝╚═╝░░░░░╚══════╝
                ${RED} X G0P9L HUI (X 99DI)
                                                  
		${CYAN}Version : 2.2 
		
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by X G0P9L HUI (X 99DI)${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE} G0P9L HUI ${RED}[ ${ORANGE}X 99DI ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/TH3G0P9LHUI
		${GREEN}Join us  ${RED}:  ${CYAN}https://INSTAGRAM
		${GREEN}Version  ${RED}:  ${ORANGE}2.2

		${REDBG}${WHITE} Thanks : X G0P9L,X 99DI${RESETBG}
